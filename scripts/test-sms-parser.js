...
// Simple test runner for SMS parser
// Run with: node scripts/test-sms-parser.js

const { parseSMS } = require('../lib/sms-parser');
const { categorizeTransaction } = require('../lib/category-rules');

// Test SMS samples from different banks
const TEST_MESSAGES = {
    HDFC: [
        {
            message: "HDFC Bank: Rs.450.00 debited from A/c **1234 on 02-02-26 at ZOMATO BANGALORE. Avl Bal Rs.12,450.50",
            expected: {
                amount: 450,
                type: 'DEBIT',
        ...
        {
            message: "HDFC: INR 85000.00 credited to A/c **5678 on 01-02-26. Avl Bal INR 97,450.50",
            expected: {
                amount: 85000,
                type: 'CREDIT',
                balance: 97450.50,
        ...
        {
            message: "HDFC Bank: Rs.1,250.75 debited from A/c **9012 at SWIGGY DELHI on 03-02-26. Avl Bal Rs.8,199.25",
            expected: {
                amount: 1250.75,
                type: 'DEBIT',
    ...
    SBI: [
        {
            message: "SBI: Debited INR 2,500.00 from A/c XX1234 to AMAZON PAY on 02-02-26. Avl Bal INR 15,600.00",
            expected: {
                amount: 2500,
                type: 'DEBIT',
                merchant: 'AMAZON PAY',
        ...
        {
            message: "SBI Bank: Credited INR 50,000.00 from SALARY CREDIT to A/c XX5678 on 01-02-26. Avl Bal INR 65,600.00",
            expected: {
                amount: 50000,
                type: 'CREDIT',
    ...
    ICICI: [
        {
            message: "ICICI Bank: Rs. 750.00 debited from A/c XX9876 to UPI-UBER-REF123456. Info: Payment successful",
            expected: {
                amount: 750,
                type: 'DEBIT',
        ...
        {
            message: "ICICI: INR 3,200.50 credited from REFUND to A/c XX4321. Info: Flipkart refund processed",
            expected: {
                amount: 3200.50,
                type: 'CREDIT',
    ...
    AXIS: [
        {
            message: "AXIS Bank: Rs. 1,800.00 debited from A/c XX7890 to NETFLIX SUBSCRIPTION on 02-02-26. avl bal INR 22,300.00",
            expected: {
                amount: 1800,
                type: 'DEBIT',
        ...
        {
            message: "AXIS: INR 5,000.00 credited to A/c XX1111 from UPI TRANSFER. avl bal Rs 27,300.00",
            expected: {
                amount: 5000,
                type: 'CREDIT',
